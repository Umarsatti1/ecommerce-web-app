        ...
        <>    
            <Box display='flex' justifyContent='space-between'>
                ...
                <Button 
                    ...
                    sx={{ m: 2, backgroundColor: '#1b272d', '&:hover': { backgroundColor: '#2d3748', }, 
                    boxShadow: '0 1px 2px rgba(0,0,0,0.1)', borderRadius: '8px' }} size='large' variant='contained'>Add Products
                </Button>
            </Box>
