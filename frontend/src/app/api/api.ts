...
const Admin = {
    ...
    fetchAllOrders: () => requests.get('orders/all-orders'), // Fetch all orders
};
...
const Account = {
    ...
    updateProfile: (profile: { firstName?: string; lastName?: string; password?: string; newPassword?: string }) =>
        requests.put("account/update-profile", profile)
};
